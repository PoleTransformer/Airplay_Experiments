...
public class AirPlay {
	...
	protected String setPassword() throws IOException {
		if (password != null) {
			...
			if (auth != null) {
				...
				throw new IOException("Authorisation required");
			}
		}
	}
	...
	protected String doHTTP(String method, String uri, ByteArrayOutputStream os, Map headers, boolean repeat) throws IOException {
		...
		if (conn.getResponseCode() == 401 || conn.getResponseCode() == 453) {
			if (repeat) {
	...
	public static void main(String[] args) {
		try {
			...
			String hostname = "192.168.1.84:7000";

			String password = "";

			Boolean stopopt = false;

			Boolean desktopopt = true;

			String photoopt = "image1.jpg";
			//String photoopt = "";
